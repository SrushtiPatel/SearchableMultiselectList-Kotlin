...
private const val ARG_PARAM1 = "selected_data"
...
class PersonFragment : Fragment() {
    ...
    private var param1: ArrayList<DmPerson> = ArrayList()
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(pSelectedValues: ArrayList<DmPerson>) =
                PersonFragment().apply {
                    arguments = Bundle().apply {
                        putParcelableArrayList(ARG_PARAM1, pSelectedValues)
                    }
                }
    }
}
